...
function createVersion($pdo)
{
    ...
    $stmt = $pdo->prepare($sql);
    $params = [
        "albumid" => $_POST["albumId"], "versionref" => $_POST["versionRef"], "formatid" => $_POST["formatId"], "labelid" => $_POST["labelId"],
        "versionpressyear" => $_POST["versionPressYear"], "versionpresspays" => $_POST["versionPressPays"], "versioneditid" => $_POST["versionEditId"], "versionimg" => "img/" . $_POST["versionImg"],
...
function editVersion($versionid, $pdo)
{
    ...
    $params = [
        "versionId" => $versionid,
        "formatId" => $_POST["formatId"], "labelId" => $_POST["labelId"],
        "versionPressYear" => $_POST["versionPressYear"], "versionPressPays" => $_POST["versionPressPays"], "versionEditId" => $_POST["versionEditId"],
